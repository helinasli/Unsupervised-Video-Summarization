...
class Generate_Dataset:
    def __init__(self,model_name, video_path, save_path):
        ...
        self.video_list = []
        self.video_path = ''
        self.frame_root_path = 'video/frame1'
    ...
    def generate_dataset(self):
        frames = [46939, 45204, 39928, 45708, 45442, 45071, 56341]
        for video_idx, video_filename in enumerate(tqdm(self.video_list)):
            ...
            fps = 2 #video_capture.get(cv2.CAP_PROP_FPS)
            n_frames = int(video_capture.get(cv2.CAP_PROP_FRAME_COUNT))
            total_frames = frames[video_idx]
            #print(n_frames)
            ...
            #self.h5_file['video_{}'.format(video_idx+1)]['frames'] = list(frame_list)
